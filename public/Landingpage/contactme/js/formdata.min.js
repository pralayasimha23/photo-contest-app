;
(function() {
    var k, l = "function" == typeof Object.defineProperties ? Object.defineProperty : function(a, b, d) {
    ...
    if ("undefined" === typeof FormData || !FormData.prototype.keys) {
        var N = function(a, b, d) {
            ...
            T = Q.Request && Q.fetch;
        n();
        var U = Q.Symbol && Symbol.toStringTag,
            V = new WeakMap,
        ...
        var X = function(a) {
            ...
            for (var b = a.next(); !b.done; b = a.next())
                if (b = b.value, b.name && !b.disabled)
                    if ("file" === b.type)
                        for (var d = w(b.files), c = d.next(); !c.done; c = d.next()) this.append(b.name, c.value);
                    else if ("select-multiple" ===
                b.type || "select-one" === b.type)
                for (d = w(W(b.options)), c = d.next(); !c.done; c = d.next()) c = c.value, !c.disabled && c.selected && this.append(b.name, c.value);
