...
exports.postLogin = (req, res, next) => {
  ...
  passport.authenticate('local', (err, user, info) => {
    ...
    if (!user || user.emailVerified == false) {
      req.flash('errors', {
        msg: "Invalid credentails or please verify your mail"
      });
      return res.redirect('/login');
    }
    req.logIn(user, (err) => {
...
exports.postSignup = (req, res, next) => {
  ...
  const sendVerificationEmail = (token) => {
    ...
    const mailOptions = {
      ...
      subject: 'Email Verification on Hackathon Starter',
      text: `You are receiving this email because you (or someone else) have requested registered account with .\n\n
    ...
    return transporter.sendMail(mailOptions)
      .then(() => {
        ...
        console.log('Success: details sent.\n');
        req.flash('info', {
...
// */
exports.getVerifyEmailLoginToken = (req, res, next) => {
  User
    .findOne({
    ...
    .then((user) => {
      ...
      if (user.emailVerified === "true") {
        req.flash('info', {
          msg: 'The email address alraedy been verified.'
        });
        return res.redirect('/login');
      }
    })
